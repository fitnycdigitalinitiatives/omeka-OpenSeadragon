...
function openseadragon_create_mdid_pyramid($record_name, $record_id, $width, $height)
{
    ...
    $pyramid = array();
	$url = array('url' => 'https://fit.vrchost.com/media/get/' . $record_id . '/' . $record_name . '/');
	...
	$url_1 = array('url' => 'https://fit.vrchost.com/media/get/' . $record_id . '/' . $record_name . '/' . $width_1 . 'x' . $height_1 . '/');
	...
	$url_2 = array('url' => 'https://fit.vrchost.com/media/get/' . $record_id . '/' . $record_name . '/' . $width_2 . 'x' . $height_2 . '/');
	$pyramid[] = $url_2 + $dimensions_2;
	$height_3 = ceil($height / 6);
	$width_3 = ceil($width / 6);
	$dimensions_3 = array('height' => (int) $height_3, 'width' => (int) $width_3);
	$url_3 = array('url' => 'https://fit.vrchost.com/media/get/' . $record_id . '/' . $record_name . '/' . $width_3 . 'x' . $height_3 . '/');
